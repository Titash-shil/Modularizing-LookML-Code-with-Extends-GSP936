...
---
 ...
 - ### Create A New `Veiw File` Named as :
...
```
 ...
 - ### Update `users.view` with the below Query :
...
- ### Update `events.view` with the below Query :
...
- ### Update `training_ecommerce.model` with the below Query :
